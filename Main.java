...
public class Main {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        String insercaoSql = "insert into pessoa(id,nome,qtdAcesso,naturalidade)values(1,'John',10,'Porto Velho')";
        stmtInsert.executeUpdate(insercaoSql);
        insercaoSql = "insert into pessoa(id,nome,qtdAcesso,naturalidade)values(2,'Cleiton',20,'Iraque')";
        stmtInsert.executeUpdate(insercaoSql);
        stmtInsert.close();
